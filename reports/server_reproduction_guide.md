...
python -m experiments.run_medqa_backbone_comparison --quick --seed 7 --max-questions 50 --models Qwen/Qwen2.5-1.5B-Instruct Qwen/Qwen2.5-3B-Instruct --merge-existing --cpu-dtype float16
